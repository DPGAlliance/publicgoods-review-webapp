...
<body class="reviewer_screen">
  <div class="container-fluid custom-container">
    ...
    <div class="row pt-3 ">
      ...
      <div class="col-6 pt-3 header_heading">
        APPLICATION TRACKING & REVIEW SYSTEM
      </div>
  ...
  */
        if($this->session->userdata('user_id') > 0 && uri_string() == 'process/inputs')
        {
