...
class Users_model extends CI_Model {
	...
	function get_all_users()
	{
		...
		*/
		 ...
		 $query=$this->db->query("select users.*, (SELECT GROUP_CONCAT(applications.id) as app_ids FROM applications WHERE applications.applicant_id=users.id GROUP BY applications.applicant_id) as app_ids from users where role != 1");
	 //echo $this->db->last_query();
	 return $query->result_array();
